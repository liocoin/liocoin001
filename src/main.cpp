...
const string strMessageMagic = "Dic Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    int64_t nSubsidy3 = 1000000*COIN;
        ...
        if(nBestHeight == 50)
        {
           nSubsidy =  (premn1 *  nSubsidy3) ;
         }
        if(nBestHeight == 100)
        {
            nSubsidy =  (premn2 *  nSubsidy3) ;
         }
        if(nBestHeight == 200)
        {
           nSubsidy =  (premn3 *  nSubsidy3) ;
         }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Dic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The times 23.9.2016. Lio project is here.";
        CTransaction txNew;
        txNew.nTime = 1525176019;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525176019;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1526125162 : 1526125162;

        assert(block.hashMerkleRoot == uint256("0xcb0acc5ccd91f9386150c78d6526e789cbcd1157bece841a862a0d7b98aabb87"));
